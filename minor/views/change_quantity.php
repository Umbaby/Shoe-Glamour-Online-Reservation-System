...
<?php
    ...
    $query = "SELECT * FROM cart WHERE p_name = '$product_name'";
                    ...
                    <table class="table">
                        ...
                        <tbody>
                                <tr>
                                    ...
                                    <td><input type="number" name="quantity" min="1" max="<?php echo $stock_row['0']; ?>" placeholder="<?php echo $row['4']; ?>" required/></td>
                                </tr>
                        </tbody>
			        </table>
