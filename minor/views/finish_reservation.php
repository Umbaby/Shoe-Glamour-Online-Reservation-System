...
include "../controllers/finish_reservation_function.php"; 
          ...
          <div class="col-lg-12">
            <div class="body-content">
                ...
                <div class="container">
                    <form action="<?php $_PHP_SELF; ?>" method="POST">
                        <fieldset>
                            <legend><p class="head">Look for Unfinished Transaction</p></legend>
                                <label for="r_number">Reservation Number</label><br>
                                    <input type="text" name="r_number" required />
                ...
                $query = "SELECT * FROM reservations WHERE r_number = '$r_number' AND status = 'unfinished' ;";
                $result = $conn->query($query);
            ...
            ?>  
                    <form action="<?php $_PHP_SELF; ?>" method="POST">
                        <table class="table">
                            ...
                            <tbody>
                                <?php while($row=$result->fetch_array()){ ?>
                                    <tr>
                                        <input type="hidden" name="r_num" value="<?php echo $row['0']; ?>"/>
                                        ...
                                        <?php $min = $row['6']; ?>
                                        <?php $max = $row['7']; ?>
                                        <!--<td><input type="date" name="date_finished" min="<?php //echo $min; ?>" max="<?php //echo $max; ?>" required/></td>-->
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <a href="view_reservations.php">Cancel</a>
                    </form>
                </div><br><br>
                <?php 
                } else { ?>
                    <div class="container">
                    <h4>No such unfinished reservation exist.</h4>
                    </div>
             <?php   }
             } ?>
            </div>
